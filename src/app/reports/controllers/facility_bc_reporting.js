(function(angular, _) {
    ...
    var results_transform = function(results, $scope) {
        var data = _.groupBy(results, function(a) {
            return a.county;
        });
    ...
    .controller("mfl.reports.controllers.bc_counties", ["$scope", "$controller",
        ...
        .controller("mfl.reports.controllers.bc_constituencies", ["$scope", "$controller",
            "$stateParams", "mfl.reports.services.wrappers",
        ...
        .controller("mfl.reports.controllers.officers_in_charge", ["$scope",
            ...
            function($scope, wrappers, exportService) {
                wrappers.facility_officers.list().success(function(data) {
                    $scope.facility_officers = data.results;
                }).error(function(data) {
                    $scope.error = data;
                });
