        ...
        .controller("mfl.facility_mgmt.controllers.facility_create.facility_print", ["$scope",
            ...
            function ($scope, wrappers, $state, $stateParams) {
                ...
                if (!_.isUndefined($stateParams.facility_id) &&
                    ...
                    wrappers.facility_hr.filter({ facility: $stateParams.facility_id, page_sizE: 100, ordering: "name" })
                        .success(function (data) {
                    ...
                    wrappers.facility_infrastructure.filter({ facility: $stateParams.facility_id, page_sizE: 100, ordering: "name" })
                        .success(function (data) {
